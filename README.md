...
- **Phase 5 — active development.** Organizational improvements that do not require real notebook
  data; navigation continuity (5a), organizational derivations (5b), and Cuaderno retrieval
  controls (5c) are complete, with activity navigation (5d) next.
...
```
npm test        # Vitest — 263 tests over the data layer, UI navigation, search, review, linking and the pipeline
```
